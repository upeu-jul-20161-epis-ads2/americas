...
class Cuenta(models.Model):
    ...
    entidad_bancaria = models.ForeignKey(
        EntidadBancaria, null=True, blank=True)
    ...
    def __str__(self):
        return '%s %s' % (self.nombre, self.numero_cuenta)
...
class Enterprise(models.Model):
    ...
    name = models.CharField(capfirst(_('name')), max_length=50)
    cuenta_bancaria = models.ForeignKey(Cuenta, blank=False, null=False)
